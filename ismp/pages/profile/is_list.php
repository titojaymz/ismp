...
$result=mysqli_query($con,"select t1.`name`, t1.category, t1.url, t1.assigned_to, t1.access, t2.`desc` as categoryname, t3.`desc` as accessname, t4.group_id, t4.group_name  
							from tbl_is as t1 
