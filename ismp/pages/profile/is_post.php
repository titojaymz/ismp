...
$sql="INSERT INTO tbl_is(id,name,category,desc,tracker,access,front_end,rdbms,url,cron,api,training_url,last_va,remarks,assigned_to,business_owner)
VALUES ('$id','$name','$category','$desc','$tracker','$access','$frontEnd','$rdbms','$url','$cron','$Api','$trainingUrl','$lastVa','$remarks','$assignedTo','$businessOwner');";
