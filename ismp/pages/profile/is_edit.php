                                    ...
                                    <form role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control">
												...
												?>
												<option value='<?php echo $row_assigned['group_id'] ?>'><?php echo $row_assigned['group_name'] ?></option>												
												<?php } ?>										
                                            </select>
                                        </div>
                                        <div class="form-group">
                                         ...
                                         <a href="is_list.php?id=<?php echo $row['id']?>"><button type="submit" class="btn btn-default">Save</button>
