...
<label>id</label>
<div class="form-control"><?php echo $row['id']?>
</div>
<label>IS ID</label>
<div class="form-control"><?php echo $row['is_id']?>
</div>
<label>Log Name</label>
<div class="form-control"><?php echo $row['log_name']?>
</div>
<label>Log Type</label>
<div class="form-control"><?php echo $row['log_type']?>
</div>
<div class="form-group">
<label>Log Description</label>
<textarea class="form-control" type="comment" row="5"><?php echo $row['log_description']?>
</textarea>
</div>
<label>Date Uploaded</label>
<div class="form-control"><?php echo $row['date_uploaded']?>
</div>
<label>Uploaded by</label>
<div class="form-control"><?php echo $row['uploaded_by']?>
</div>
<div class="form-group">
<label>Fix Description</label><textarea class="form-control" row="10" type="text"><?php echo $row['fix_description']?>
</textarea>
</div>

<a href="log_edit.php?id=<?php echo $row['id'] ?>"><button type=button class = "btn btn-success btn">EDIT</button></a>
