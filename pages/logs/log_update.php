...
$sql="UPDATE tbl_is_log SET is_id='$isid',log_name='$ln',log_type='$lt',log_description='$ld',date_uploaded='$du',uploaded_by='$uby',fix_description='$fd' WHERE id ='$id'";
	...
	if (!mysqli_query($con,$sql)) { // executes the query and checks if it was properly executed
		...
		echo "success!"; // shows the message, user defined most of the time. bahala ka na hehe
		echo '<a href="log_list.php"><button type="button" class="btn btn-primary btn-l">LIST</button></a>';
